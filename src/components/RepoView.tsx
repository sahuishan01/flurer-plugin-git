...
export function RepoView(props: RepoViewProps) {
  ...
  return (
    <div style={{ height: "100%", width: "100%", display: "flex", "flex-direction": "column", overflow: "hidden", "box-sizing": "border-box", position: "relative" }}>
      <div style={{ ...S.section, "border-bottom": "1px solid rgba(255, 255, 255, 0.08)", "flex-shrink": 0, background: "rgba(var(--panel-rgb, 10, 14, 23), 0.35)", "backdrop-filter": "blur(16px)", position: "relative", "z-index": 10 }}>
        <div style={S.toolbar}>
